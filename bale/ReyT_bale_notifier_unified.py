...
EXECUTION_REASON_FA = {
    ...
    "RISK_BUDGET_EXCEEDED": "ریسک معامله از سقف تنظیم‌شده عبور می‌کرد",
...
EXECUTION_REASON_FA.update({
    ...
    "PP_ONE_UNIT_EXCEEDS_MAX_CAPITAL":
        "حتی یک واحد کامل پروتکتیو پوت بیش از سقف ۱۰ میلیون تومان سرمایه نیاز دارد",
    "PP_MAX_CAPITAL_EXCEEDED":
        "سرمایه پروتکتیو پوت از سقف ۱۰ میلیون تومان بیشتر است",
    "PP_VWAP_MAX_CAPITAL_EXCEEDED":
        "سرمایه پروتکتیو پوت پس از VWAP از سقف ۱۰ میلیون تومان عبور کرده است",
